...
Some of these observations are non-trivial and the proofs are in [Proofs](#proofs). In searching for an optimal strategy, we can iterate through different possible values of
